...
# anm = m.ANM(fcoord, ex_bfacts, T=300)
...
# print(tf)
#
p = m.protein('1bu4.pdb', cutoff=15, pottype='s', potential=5.0, Angle_Constraint=True, a1s=ANMT.normal_vectors, a3s=ANMT.a3s)
p.WriteSimFiles()
...
#
# s1msd, s1bfacts = m.load_sim_rmsds_from_file('5kb0kt.json')
# m.free 33compare('5kb0kt.png', s1bfacts, legends=['5kb0kt'])
